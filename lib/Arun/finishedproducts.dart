...
class Finishedproducts extends StatefulWidget {
  const Finishedproducts({super.key});

  @override
  State<Finishedproducts> createState() => _FinishedproductsState();
}
